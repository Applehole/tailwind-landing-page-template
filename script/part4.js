...
*/
const PART4_3 = `
insert into user (id, name, email) Values (5,'injae', 'injae.com')
`;
...
*/
const PART4_5 = `select name from user where not name='duhyunkim'`;
...
*/
const PART4_7 = `select title,name from content left join user on content.userId= user.id`;
...
*/
const PART4_8 = `select title,name from content inner join user on content.userId= user.id`;
...
*/
const PART4_10 = `insert into content (id,title,body,created_at,userId) values (4,'재밌다~','히히 재밌다~','2022-01-24', 1)`;
